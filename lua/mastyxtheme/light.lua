-- variante "light" del tema
-- stessa struttura di init.lua ma con palette_light e alcune regole dedicate:
-- sfondo chiaro azzurrino, testo nero, keyword in blu, errori in rosso, parentesi in arancio
...
function M.setup()
  ...
  vim.g.colors_name = "mastyxtheme-light"

  local c = require("mastyxtheme.palette_light")
  ...
  hl(0, "@constructor", { fg = c.light_red })
  ...
  hl(0, "@type", { fg = c.light_red, bold = true })
  hl(0, "@type.builtin", { fg = c.light_red, italic = true })
  hl(0, "@storageclass", { fg = c.blue })
